...
require("lazy").setup({
	...
	{ -- Useful plugin for auto-closing brackets and quotes.
		"windwp/nvim-autopairs",
		event = "InsertEnter", -- Loads the plugin when entering insert mode
		opts = {
			-- disable autopairs in these file types
			disable_filetype = { "TelescopePrompt", "vim" },
			-- enable treesitter integration for smarter autopairing (if you have treesitter configured)
			check_ts = true,
